...
defmodule PolarExpress.Schemas.BenefitGrantDownloadablesWebhook do
  @moduledoc """
  ...
  * `subscription_id` - The ID of the subscription that granted this benefit. Nullable.
  """
  @type t :: %__MODULE__{
          benefit: PolarExpress.Schemas.BenefitDownloadables.t() | nil,
          ...
          previous_properties: PolarExpress.Schemas.BenefitGrantDownloadablesProperties.t() | nil,
          properties: PolarExpress.Schemas.BenefitGrantDownloadablesProperties.t() | nil,
  ...
  @schema_name "BenefitGrantDownloadablesWebhook"
  def schema_name, do: @schema_name

  def __inner_types__ do
    %{
      "benefit" => PolarExpress.Schemas.BenefitDownloadables,
      "customer" => PolarExpress.Schemas.Customer,
      "error" => PolarExpress.Schemas.BenefitGrantError,
      "member" => PolarExpress.Schemas.Member,
      "previous_properties" => PolarExpress.Schemas.BenefitGrantDownloadablesProperties,
      "properties" => PolarExpress.Schemas.BenefitGrantDownloadablesProperties
    }
  end
