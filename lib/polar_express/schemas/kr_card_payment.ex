...
defmodule PolarExpress.Schemas.KrCardPayment do
  @moduledoc """
  KrCardPayment
  ...
  * `method_metadata` - Additional metadata for the South Korean card payment method.
  ...
  * `trigger` - What initiated this payment attempt, e.g. initial purchase, subscription renewal, or an automated dunning retry. Nullable.
  ...
  @schema_name "KrCardPayment"
  def schema_name, do: @schema_name

  def __inner_types__ do
    %{
      "method_metadata" => PolarExpress.Schemas.KrCardPaymentMetadata,
