...
defmodule PolarExpress.Schemas.SubscriptionReinstatedEvent do
  @moduledoc """
  ...
  * `timestamp` - The timestamp of the event. Format: date-time.
  ...
  @schema_name "SubscriptionReinstatedEvent"
  def schema_name, do: @schema_name

  def __inner_types__ do
    %{
      "customer" => PolarExpress.Schemas.Customer,
      "metadata" => PolarExpress.Schemas.SubscriptionReinstatedMetadata
    }
  end
