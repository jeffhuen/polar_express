...
defmodule PolarExpress.Schemas.BalanceCreditOrderEvent do
  @moduledoc """
  ...
  * `timestamp` - The timestamp of the event. Format: date-time.
  ...
  @type t :: %__MODULE__{
          ...
          metadata: PolarExpress.Schemas.BalanceCreditOrderMetadata.t() | nil,
          name: String.t() | nil,
  ...
  @schema_name "BalanceCreditOrderEvent"
  def schema_name, do: @schema_name

  def __inner_types__ do
    %{
      "customer" => PolarExpress.Schemas.Customer,
      "metadata" => PolarExpress.Schemas.BalanceCreditOrderMetadata
    }
  end
