...
defmodule PolarExpress.Schemas.CustomerCreatedEvent do
  @moduledoc """
  ...
  * `timestamp` - The timestamp of the event. Format: date-time.
  ...
  @type t :: %__MODULE__{
          ...
          metadata: PolarExpress.Schemas.CustomerCreatedMetadata.t() | nil,
          name: String.t() | nil,
  ...
  @schema_name "CustomerCreatedEvent"
  def schema_name, do: @schema_name

  def __inner_types__ do
    %{
      "customer" => PolarExpress.Schemas.Customer,
      "metadata" => PolarExpress.Schemas.CustomerCreatedMetadata
    }
  end
