...
defmodule PolarExpress.Schemas.EventTypeWithStats do
  ...
  @typedoc """
  * `created_at` - Creation timestamp of the event type. Null for system event types. Nullable.
  * `first_seen` - The first time the event occurred. Format: date-time.
  * `id` - The ID of the event type. Null for system event types. Nullable.
  ...
  * `modified_at` - Last modification timestamp of the event type. Null for system event types. Nullable.
