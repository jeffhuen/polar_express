...
defmodule PolarExpress.Schemas.BalanceOrderEvent do
  @moduledoc """
  BalanceOrderEvent
  ...
  * `timestamp` - The timestamp of the event. Format: date-time.
  ...
  @type t :: %__MODULE__{
          ...
          metadata: PolarExpress.Schemas.BalanceOrderMetadata.t() | nil,
          name: String.t() | nil,
  ...
  @schema_name "BalanceOrderEvent"
  def schema_name, do: @schema_name

  def __inner_types__ do
    %{
      "customer" => PolarExpress.Schemas.Customer,
      "metadata" => PolarExpress.Schemas.BalanceOrderMetadata
    }
  end
