...
defmodule PolarExpress.Schemas.CustomerUpdatedEvent do
  @moduledoc """
  ...
  * `timestamp` - The timestamp of the event. Format: date-time.
  ...
  @type t :: %__MODULE__{
          ...
          metadata: PolarExpress.Schemas.CustomerUpdatedMetadata.t() | nil,
          name: String.t() | nil,
  ...
  @schema_name "CustomerUpdatedEvent"
  def schema_name, do: @schema_name

  def __inner_types__ do
    %{
      "customer" => PolarExpress.Schemas.Customer,
      "metadata" => PolarExpress.Schemas.CustomerUpdatedMetadata
    }
  end
