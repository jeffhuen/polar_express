...
defmodule PolarExpress.Schemas.SubscriptionUpdateClearedEvent do
  @moduledoc """
  ...
  * `timestamp` - The timestamp of the event. Format: date-time.
  ...
  @type t :: %__MODULE__{
          ...
          metadata: PolarExpress.Schemas.SubscriptionUpdateClearedMetadata.t() | nil,
          name: String.t() | nil,
  ...
  @schema_name "SubscriptionUpdateClearedEvent"
  def schema_name, do: @schema_name

  def __inner_types__ do
    %{
      "customer" => PolarExpress.Schemas.Customer,
      "metadata" => PolarExpress.Schemas.SubscriptionUpdateClearedMetadata
    }
  end
