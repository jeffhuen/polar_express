...
defmodule PolarExpress.Schemas.CustomFieldCreateNumber do
  @moduledoc """
  ...
  * `type`
  ...
  @schema_name "CustomFieldCreateNumber"
  def schema_name, do: @schema_name

  def __inner_types__ do
    %{
      "properties" => PolarExpress.Schemas.CustomFieldNumberProperties
    }
  end
end
