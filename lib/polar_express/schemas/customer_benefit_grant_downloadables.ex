...
defmodule PolarExpress.Schemas.CustomerBenefitGrantDownloadables do
  @moduledoc """
  ...
  * `subscription_id` - Nullable.
  """
  @type t :: %__MODULE__{
          benefit: PolarExpress.Schemas.BenefitDownloadablesSubscriber.t() | nil,
  ...
  @schema_name "CustomerBenefitGrantDownloadables"
  def schema_name, do: @schema_name

  def __inner_types__ do
    %{
      "benefit" => PolarExpress.Schemas.BenefitDownloadablesSubscriber,
