...
defmodule PolarExpress.Schemas.BenefitDownloadablesSubscriber do
  @moduledoc """
  ...
  * `type`
  ...
  @type t :: %__MODULE__{
          ...
          properties: PolarExpress.Schemas.BenefitDownloadablesSubscriberProperties.t() | nil,
  ...
  @schema_name "BenefitDownloadablesSubscriber"
