...
defmodule PolarExpress.Schemas.CustomerBenefitGrantSlackSharedChannel do
  @moduledoc """
  ...
  * `subscription_id` - Nullable.
  """
  @type t :: %__MODULE__{
          benefit: PolarExpress.Schemas.BenefitSlackSharedChannelSubscriber.t() | nil,
  ...
  @schema_name "CustomerBenefitGrantSlackSharedChannel"
  def schema_name, do: @schema_name

  def __inner_types__ do
    %{
      "benefit" => PolarExpress.Schemas.BenefitSlackSharedChannelSubscriber,
