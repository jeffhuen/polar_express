...
defmodule PolarExpress.Schemas.MeterResetEvent do
  @moduledoc """
  MeterResetEvent
  ...
  * `timestamp` - The timestamp of the event. Format: date-time.
  ...
  @type t :: %__MODULE__{
          ...
          metadata: PolarExpress.Schemas.MeterResetMetadata.t() | nil,
          name: String.t() | nil,
  ...
  @schema_name "MeterResetEvent"
  def schema_name, do: @schema_name

  def __inner_types__ do
    %{
      "customer" => PolarExpress.Schemas.Customer,
      "metadata" => PolarExpress.Schemas.MeterResetMetadata
    }
  end
