...
defmodule PolarExpress.Schemas.CustomerOrder do
  @moduledoc """
  CustomerOrder
  """
  ...
  * `next_payment_attempt_at` - When the next payment retry is scheduled Nullable.
  ...
  * `user_id` - Format: uuid4. **Deprecated.**
  ...
  @type t :: %__MODULE__{
          ...
          paid: boolean() | nil,
          product: PolarExpress.Schemas.CustomerOrderProduct.t() | nil,
          product_id: String.t() | nil,
          refunded_amount: integer() | nil,
          refunded_tax_amount: integer() | nil,
          seats: integer() | nil,
          status: PolarExpress.Schemas.OrderStatus.t() | nil,
          subscription: PolarExpress.Schemas.CustomerOrderSubscription.t() | nil,
  ...
  def __inner_types__ do
    %{
      ...
      "product" => PolarExpress.Schemas.CustomerOrderProduct,
      "status" => PolarExpress.Schemas.OrderStatus,
      "subscription" => PolarExpress.Schemas.CustomerOrderSubscription
    }
  end
