...
defmodule PolarExpress.Schemas.MeterCreditEvent do
  @moduledoc """
  MeterCreditEvent
  ...
  * `timestamp` - The timestamp of the event. Format: date-time.
  ...
  @type t :: %__MODULE__{
          ...
          metadata: PolarExpress.Schemas.MeterCreditedMetadata.t() | nil,
          name: String.t() | nil,
  ...
  @schema_name "MeterCreditEvent"
  def schema_name, do: @schema_name

  def __inner_types__ do
    %{
      "customer" => PolarExpress.Schemas.Customer,
      "metadata" => PolarExpress.Schemas.MeterCreditedMetadata
    }
  end
