...
defmodule PolarExpress.Schemas.BenefitSlackSharedChannelCreate do
  @moduledoc """
  ...
  * `visibility` - The visibility of the benefit in the customer portal. Nullable.
  ...
  @type t :: %__MODULE__{
          ...
          properties: PolarExpress.Schemas.BenefitSlackSharedChannelCreateProperties.t() | nil,
          type: String.t() | nil,
  ...
  @schema_name "BenefitSlackSharedChannelCreate"
  def schema_name, do: @schema_name

  def __inner_types__ do
    %{
      "properties" => PolarExpress.Schemas.BenefitSlackSharedChannelCreateProperties,
