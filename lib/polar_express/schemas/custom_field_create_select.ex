...
defmodule PolarExpress.Schemas.CustomFieldCreateSelect do
  @moduledoc """
  ...
  * `type`
  ...
  @type t :: %__MODULE__{
          ...
          properties: PolarExpress.Schemas.CustomFieldSelectProperties.t() | nil,
          slug: String.t() | nil,
          type: String.t() | nil
        }
  ...
  @schema_name "CustomFieldCreateSelect"
  def schema_name, do: @schema_name

  def __inner_types__ do
    %{
      "properties" => PolarExpress.Schemas.CustomFieldSelectProperties
    }
  end
end
