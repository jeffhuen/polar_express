...
defmodule PolarExpress.Schemas.SubscriptionCycledEvent do
  @moduledoc """
  ...
  * `timestamp` - The timestamp of the event. Format: date-time.
  ...
  @type t :: %__MODULE__{
          ...
          metadata: PolarExpress.Schemas.SubscriptionCycledMetadata.t() | nil,
          name: String.t() | nil,
  ...
  @schema_name "SubscriptionCycledEvent"
  def schema_name, do: @schema_name

  def __inner_types__ do
    %{
      "customer" => PolarExpress.Schemas.Customer,
      "metadata" => PolarExpress.Schemas.SubscriptionCycledMetadata
    }
  end
