...
defmodule PolarExpress.Schemas.OrderPaidEvent do
  @moduledoc """
  OrderPaidEvent
  ...
  * `timestamp` - The timestamp of the event. Format: date-time.
  ...
  @type t :: %__MODULE__{
          ...
          metadata: PolarExpress.Schemas.OrderPaidMetadata.t() | nil,
          name: String.t() | nil,
  ...
  @schema_name "OrderPaidEvent"
  def schema_name, do: @schema_name

  def __inner_types__ do
    %{
      "customer" => PolarExpress.Schemas.Customer,
      "metadata" => PolarExpress.Schemas.OrderPaidMetadata
    }
  end
