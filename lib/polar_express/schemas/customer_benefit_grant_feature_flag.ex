...
defmodule PolarExpress.Schemas.CustomerBenefitGrantFeatureFlag do
  @moduledoc """
  ...
  * `subscription_id` - Nullable.
  """
  @type t :: %__MODULE__{
          benefit: PolarExpress.Schemas.BenefitFeatureFlagSubscriber.t() | nil,
  ...
  @schema_name "CustomerBenefitGrantFeatureFlag"
  def schema_name, do: @schema_name

  def __inner_types__ do
    %{
      "benefit" => PolarExpress.Schemas.BenefitFeatureFlagSubscriber,
