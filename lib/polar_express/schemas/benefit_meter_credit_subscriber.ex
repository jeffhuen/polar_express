...
defmodule PolarExpress.Schemas.BenefitMeterCreditSubscriber do
  @moduledoc """
  ...
  * `type`
  ...
  @type t :: %__MODULE__{
          ...
          properties: PolarExpress.Schemas.BenefitMeterCreditSubscriberProperties.t() | nil,
  ...
  @schema_name "BenefitMeterCreditSubscriber"
  ...
  def __inner_types__ do
    %{
      ...
      "properties" => PolarExpress.Schemas.BenefitMeterCreditSubscriberProperties
    }
  end
