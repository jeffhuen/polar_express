...
defmodule PolarExpress.Schemas.DiscountPercentageOnceForeverDurationBase do
  @moduledoc """
  ...
  * `max_redemptions_per_customer` - Maximum number of times the discount can be redeemed by a single customer. Nullable.
  * `metadata`
  ...
  * `type`
  ...
  @schema_name "DiscountPercentageOnceForeverDurationBase"
