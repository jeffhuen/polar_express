...
defmodule PolarExpress.Schemas.BenefitCustomSubscriber do
  @moduledoc """
  ...
  * `type`
  ...
  @type t :: %__MODULE__{
          ...
          properties: PolarExpress.Schemas.BenefitCustomSubscriberProperties.t() | nil,
  ...
  @schema_name "BenefitCustomSubscriber"
  def schema_name, do: @schema_name

  def __inner_types__ do
    %{
      "organization" => PolarExpress.Schemas.BenefitSubscriberOrganization,
      "properties" => PolarExpress.Schemas.BenefitCustomSubscriberProperties
    }
  end
