...
defmodule PolarExpress.Schemas.BenefitGitHubRepositorySubscriber do
  @moduledoc """
  ...
  * `type`
  ...
  @type t :: %__MODULE__{
          ...
          properties: PolarExpress.Schemas.BenefitGitHubRepositorySubscriberProperties.t() | nil,
  ...
  @schema_name "BenefitGitHubRepositorySubscriber"
  ...
  def __inner_types__ do
    %{
      ...
      "properties" => PolarExpress.Schemas.BenefitGitHubRepositorySubscriberProperties
    }
  end
