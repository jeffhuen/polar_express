...
defmodule PolarExpress.Schemas.CustomerBenefitGrantMeterCredit do
  @moduledoc """
  ...
  * `subscription_id` - Nullable.
  """
  @type t :: %__MODULE__{
          benefit: PolarExpress.Schemas.BenefitMeterCreditSubscriber.t() | nil,
  ...
  @schema_name "CustomerBenefitGrantMeterCredit"
  def schema_name, do: @schema_name

  def __inner_types__ do
    %{
      "benefit" => PolarExpress.Schemas.BenefitMeterCreditSubscriber,
