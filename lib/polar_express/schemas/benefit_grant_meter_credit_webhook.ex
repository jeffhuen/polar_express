...
defmodule PolarExpress.Schemas.BenefitGrantMeterCreditWebhook do
  @moduledoc """
  ...
  * `subscription_id` - The ID of the subscription that granted this benefit. Nullable.
  """
  @type t :: %__MODULE__{
          benefit: PolarExpress.Schemas.BenefitMeterCredit.t() | nil,
          ...
          previous_properties: PolarExpress.Schemas.BenefitGrantMeterCreditProperties.t() | nil,
          properties: PolarExpress.Schemas.BenefitGrantMeterCreditProperties.t() | nil,
  ...
  @schema_name "BenefitGrantMeterCreditWebhook"
  def schema_name, do: @schema_name

  def __inner_types__ do
    %{
      "benefit" => PolarExpress.Schemas.BenefitMeterCredit,
      "customer" => PolarExpress.Schemas.Customer,
      "error" => PolarExpress.Schemas.BenefitGrantError,
      "member" => PolarExpress.Schemas.Member,
      "previous_properties" => PolarExpress.Schemas.BenefitGrantMeterCreditProperties,
      "properties" => PolarExpress.Schemas.BenefitGrantMeterCreditProperties
    }
  end
