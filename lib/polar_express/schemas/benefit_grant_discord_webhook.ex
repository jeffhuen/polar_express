...
defmodule PolarExpress.Schemas.BenefitGrantDiscordWebhook do
  @moduledoc """
  ...
  * `subscription_id` - The ID of the subscription that granted this benefit. Nullable.
  """
  @type t :: %__MODULE__{
          benefit: PolarExpress.Schemas.BenefitDiscord.t() | nil,
          ...
          previous_properties: PolarExpress.Schemas.BenefitGrantDiscordProperties.t() | nil,
  ...
  @schema_name "BenefitGrantDiscordWebhook"
  def schema_name, do: @schema_name

  def __inner_types__ do
    %{
      "benefit" => PolarExpress.Schemas.BenefitDiscord,
      "customer" => PolarExpress.Schemas.Customer,
      "error" => PolarExpress.Schemas.BenefitGrantError,
      "member" => PolarExpress.Schemas.Member,
      "previous_properties" => PolarExpress.Schemas.BenefitGrantDiscordProperties,
