...
defmodule PolarExpress.Schemas.BenefitGrantedEvent do
  @moduledoc """
  BenefitGrantedEvent
  ...
  * `timestamp` - The timestamp of the event. Format: date-time.
  ...
  @type t :: %__MODULE__{
          ...
          metadata: PolarExpress.Schemas.BenefitGrantMetadata.t() | nil,
          name: String.t() | nil,
  ...
  @schema_name "BenefitGrantedEvent"
  def schema_name, do: @schema_name

  def __inner_types__ do
    %{
      "customer" => PolarExpress.Schemas.Customer,
      "metadata" => PolarExpress.Schemas.BenefitGrantMetadata
    }
  end
