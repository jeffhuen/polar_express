...
defmodule PolarExpress.Schemas.BenefitGrantSlackSharedChannelWebhook do
  @moduledoc """
  ...
  * `subscription_id` - The ID of the subscription that granted this benefit. Nullable.
  """
  @type t :: %__MODULE__{
          benefit: PolarExpress.Schemas.BenefitSlackSharedChannel.t() | nil,
          ...
          previous_properties:
            PolarExpress.Schemas.BenefitGrantSlackSharedChannelProperties.t() | nil,
          properties: PolarExpress.Schemas.BenefitGrantSlackSharedChannelProperties.t() | nil,
  ...
  @schema_name "BenefitGrantSlackSharedChannelWebhook"
  def schema_name, do: @schema_name

  def __inner_types__ do
    %{
      "benefit" => PolarExpress.Schemas.BenefitSlackSharedChannel,
      "customer" => PolarExpress.Schemas.Customer,
      "error" => PolarExpress.Schemas.BenefitGrantError,
      "member" => PolarExpress.Schemas.Member,
      "previous_properties" => PolarExpress.Schemas.BenefitGrantSlackSharedChannelProperties,
      "properties" => PolarExpress.Schemas.BenefitGrantSlackSharedChannelProperties
    }
  end
