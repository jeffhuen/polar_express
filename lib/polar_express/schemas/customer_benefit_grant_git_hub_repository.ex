...
defmodule PolarExpress.Schemas.CustomerBenefitGrantGitHubRepository do
  @moduledoc """
  ...
  * `subscription_id` - Nullable.
  """
  @type t :: %__MODULE__{
          benefit: PolarExpress.Schemas.BenefitGitHubRepositorySubscriber.t() | nil,
  ...
  @schema_name "CustomerBenefitGrantGitHubRepository"
  def schema_name, do: @schema_name

  def __inner_types__ do
    %{
      "benefit" => PolarExpress.Schemas.BenefitGitHubRepositorySubscriber,
