...
defmodule PolarExpress.Schemas.BenefitGitHubRepositoryUpdate do
  @moduledoc """
  ...
  * `type`
  ...
  @type t :: %__MODULE__{
          ...
          properties: PolarExpress.Schemas.BenefitGitHubRepositoryCreateProperties.t() | nil,
          type: String.t() | nil
        }

  defstruct [:description, :metadata, :properties, :type]

  @schema_name "BenefitGitHubRepositoryUpdate"
  def schema_name, do: @schema_name

  def __inner_types__ do
    %{
      "properties" => PolarExpress.Schemas.BenefitGitHubRepositoryCreateProperties
    }
  end
end
