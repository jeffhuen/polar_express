...
defmodule PolarExpress.Schemas.EventCreateCustomer do
  @moduledoc """
  EventCreateCustomer
  """

  @typedoc """
  * `customer_id` - ID of the customer in your Polar organization associated with the event. Format: uuid4.
  * `external_id` - Your unique identifier for this event. Useful for deduplication and parent-child relationships. Nullable.
  * `member_id` - ID of the member within the customer's organization who performed the action. Used for member-level attribution in B2B. Nullable.
  ...
  * `timestamp` - The timestamp of the event. Format: date-time.
  ...
  @schema_name "EventCreateCustomer"
