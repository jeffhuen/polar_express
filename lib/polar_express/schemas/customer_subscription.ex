...
defmodule PolarExpress.Schemas.CustomerSubscription do
  @moduledoc """
  ...
  * `trial_start` - The start timestamp of the trial period, if any. Nullable.
  ...
  @type t :: %__MODULE__{
          ...
          prices:
            ...
            | nil,
          product: PolarExpress.Schemas.CustomerSubscriptionProduct.t() | nil,
  ...
  @schema_name "CustomerSubscription"
  ...
  def __inner_types__ do
    %{
      ...
      "product" => PolarExpress.Schemas.CustomerSubscriptionProduct,
