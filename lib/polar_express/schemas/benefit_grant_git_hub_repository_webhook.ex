...
defmodule PolarExpress.Schemas.BenefitGrantGitHubRepositoryWebhook do
  @moduledoc """
  ...
  * `subscription_id` - The ID of the subscription that granted this benefit. Nullable.
  """
  @type t :: %__MODULE__{
          benefit: PolarExpress.Schemas.BenefitGitHubRepository.t() | nil,
          ...
          previous_properties:
            PolarExpress.Schemas.BenefitGrantGitHubRepositoryProperties.t() | nil,
          properties: PolarExpress.Schemas.BenefitGrantGitHubRepositoryProperties.t() | nil,
  ...
  @schema_name "BenefitGrantGitHubRepositoryWebhook"
  def schema_name, do: @schema_name

  def __inner_types__ do
    %{
      "benefit" => PolarExpress.Schemas.BenefitGitHubRepository,
      "customer" => PolarExpress.Schemas.Customer,
      "error" => PolarExpress.Schemas.BenefitGrantError,
      "member" => PolarExpress.Schemas.Member,
      "previous_properties" => PolarExpress.Schemas.BenefitGrantGitHubRepositoryProperties,
      "properties" => PolarExpress.Schemas.BenefitGrantGitHubRepositoryProperties
    }
  end
