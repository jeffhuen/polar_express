...
defmodule PolarExpress.Schemas.BenefitFeatureFlagSubscriber do
  @moduledoc """
  ...
  * `type`
  ...
  @type t :: %__MODULE__{
          ...
          properties: PolarExpress.Schemas.BenefitFeatureFlagSubscriberProperties.t() | nil,
  ...
  @schema_name "BenefitFeatureFlagSubscriber"
  ...
  def __inner_types__ do
    %{
      ...
      "properties" => PolarExpress.Schemas.BenefitFeatureFlagSubscriberProperties
    }
  end
