...
defmodule PolarExpress.Schemas.OrderVoidedEvent do
  @moduledoc """
  OrderVoidedEvent
  ...
  * `timestamp` - The timestamp of the event. Format: date-time.
  ...
  @type t :: %__MODULE__{
          ...
          metadata: PolarExpress.Schemas.OrderVoidedMetadata.t() | nil,
          name: String.t() | nil,
  ...
  @schema_name "OrderVoidedEvent"
  def schema_name, do: @schema_name

  def __inner_types__ do
    %{
      "customer" => PolarExpress.Schemas.Customer,
      "metadata" => PolarExpress.Schemas.OrderVoidedMetadata
    }
  end
