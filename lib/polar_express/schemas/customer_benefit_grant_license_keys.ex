...
defmodule PolarExpress.Schemas.CustomerBenefitGrantLicenseKeys do
  @moduledoc """
  ...
  * `subscription_id` - Nullable.
  """
  @type t :: %__MODULE__{
          benefit: PolarExpress.Schemas.BenefitLicenseKeysSubscriber.t() | nil,
  ...
  @schema_name "CustomerBenefitGrantLicenseKeys"
  def schema_name, do: @schema_name

  def __inner_types__ do
    %{
      "benefit" => PolarExpress.Schemas.BenefitLicenseKeysSubscriber,
