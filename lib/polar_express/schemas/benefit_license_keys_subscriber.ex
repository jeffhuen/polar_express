...
defmodule PolarExpress.Schemas.BenefitLicenseKeysSubscriber do
  @moduledoc """
  ...
  * `type`
  ...
  @type t :: %__MODULE__{
          ...
          properties: PolarExpress.Schemas.BenefitLicenseKeysSubscriberProperties.t() | nil,
  ...
  @schema_name "BenefitLicenseKeysSubscriber"
  def schema_name, do: @schema_name

  def __inner_types__ do
    %{
      "organization" => PolarExpress.Schemas.BenefitSubscriberOrganization,
      "properties" => PolarExpress.Schemas.BenefitLicenseKeysSubscriberProperties
    }
  end
