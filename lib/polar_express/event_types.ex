...
defmodule PolarExpress.EventTypes do
  ...
  def event_type_to_schema do
    %{
      ...
      "discount.created" => PolarExpress.Schemas.Discount,
      "discount.deleted" => PolarExpress.Schemas.Discount,
      "discount.updated" => PolarExpress.Schemas.Discount,
      ...
      "subscription.cycled" => PolarExpress.Schemas.Subscription,
      "subscription.migrated" => PolarExpress.Schemas.Subscription,
  ...
  def event_type_to_module do
    %{
      ...
      "discount.created" => PolarExpress.Events.DiscountCreated,
      "discount.deleted" => PolarExpress.Events.DiscountDeleted,
      "discount.updated" => PolarExpress.Events.DiscountUpdated,
      ...
      "subscription.cycled" => PolarExpress.Events.SubscriptionCycled,
      "subscription.migrated" => PolarExpress.Events.SubscriptionMigrated,
