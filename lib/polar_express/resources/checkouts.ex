...
defmodule PolarExpress.Resources.Checkouts do
  ...
  * `url` - URL where the customer can access the checkout session.
  """
  @type t :: %__MODULE__{
          active_trial_interval: map() | nil,
          active_trial_interval_count: map() | nil,
          ...
          customer_billing_address: map() | nil,
          customer_billing_name: map() | nil,
          customer_email: map() | nil,
          customer_external_id: map() | nil,
          customer_id: map() | nil,
          customer_ip_address: map() | nil,
          customer_metadata: map() | nil,
          customer_name: map() | nil,
          customer_tax_id: map() | nil,
          discount: map() | nil,
          discount_amount: integer() | nil,
          discount_id: map() | nil,
          embed_origin: map() | nil,
          ...
          price_per_seat: map() | nil,
          prices: map() | nil,
          product: map() | nil,
          product_id: map() | nil,
          product_price: map() | nil,
          product_price_id: map() | nil,
          products: [map()] | nil,
